...
import kato.input.known_schemas
from kato.input.known_schemas.base import K8sSchema
from kato.input.testcase import K8sInvalidTestCase
from kato.schema import ArraySchema, BaseSchema, ObjectSchema, extract_schema
...
def find_matched_schema(schema: BaseSchema) -> List[List[str]]:
    matched_schemas = []
    for name, obj in inspect.getmembers(kato.input.known_schemas):
